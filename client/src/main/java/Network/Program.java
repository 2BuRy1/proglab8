...
public class Program {
    ...
    public void execute() throws InvalidDataException, InterruptedException {
        ...
        listOfCommands.putCommands(new Commands.Show());
        listOfCommands.putCommands(new Clear());
        listOfCommands.putCommands(new Commands.Sort());
        ...
        listOfCommands.putCommands(new Commands.Insert());
        listOfCommands.putCommands(new Commands.Remove());
        listOfCommands.putCommands(new Commands.CountLess());
        listOfCommands.putCommands(new ExecuteScript());
        listOfCommands.putCommands(new Login());
        listOfCommands.putCommands(new Commands.Register());
        String[] input;
